import blackPepperImg from "../../assets/white-pep.png";

const BlackPepper = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white-100 via-green-50 to-green-100 flex flex-col pt-20">
      {/* Page Content */}
      <main className="flex-1 flex justify-center items-center px-6 py-12">
        <div className="relative bg-gradient-to-br from-white via-green-50 to-white-50 rounded-3xl shadow-2xl border-4 border-[#5E8F8D] max-w-6xl w-full grid md:grid-cols-2 gap-8 p-6 md:p-12 transition-transform hover:scale-[1.01] duration-300 ease-out">

          {/* Decorative Background Gradient */}
          <div className="absolute -inset-1 -z-10 rounded-3xl bg-gradient-to-r from-green-200/50 via-neutral-100/50 to-green-200/50 blur-2xl opacity-50"></div>
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#5E8F8D] mb-6 tracking-tight leading-tight">
              White Pepper <span className="text-yellow-600">Powder</span>
            </h1>
